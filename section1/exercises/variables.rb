...
# I assumed from the name of the variable that first_name should store a name, which would be a string. The variable is_hungry seemed like it should store a boolean because the variable name infers its storing a binary state.
#The variable name number_of_pets seems to be suggesting that the data type should be an integer because it refers to the number of something.
